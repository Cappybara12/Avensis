        ...
        tabs: [
          {
            ...
            image: image1,
            id:0,
            content: "Algo Hunt by geek room is a realm of data strcutres and algorithms where participants will compete to win exciting przies by their problem solving capabilities"
          },
,
          { 
            name:"PRIZES",
            image: image1,
            id:2,
            content: " <div className= 'font-bold text-white'>  First Prize: ₹6000    <br/>         <br/>    </div>"
          },
          {
            name:"SPEAKERS",
            image: image1,
